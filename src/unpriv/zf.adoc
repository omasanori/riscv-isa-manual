...
The ext:f[], ext:d[], and ext:q[] extensions uses 32 floating-point registers,
`f0`-`f31`, and a floating-point CSR, csr:fcsr[], that contains the operating
mode and exception status of the floating-point unit. This additional state is
shown in <<fprs>>.
