...
quad-precision floating-point is unlikely to be implemented in hardware, and so
we do not require or expect software to expend effort optimizing use of `Q`
...
NOTE: The `Zicsr` extension is not supported independent of the `Zicntr` or `F`
extensions.
